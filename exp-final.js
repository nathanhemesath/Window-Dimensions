		...
		var setupTestAction = function(){
			$('#tab-slider--nav li').click(function(){
				...
				if (window.location.href.toLowerCase().indexOf('search') > -1) {
					var expSearchCheck = 'pt_search-result';
					$('body').addClass("" + expSearchCheck);
				}

				if ($("#product-lists").length > 0) {
					var expCheckPGP = 'pt_pgp-result';
					$('body').addClass("" + expCheckPGP);
				}
			});
		};
